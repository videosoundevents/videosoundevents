...
const Categories: React.FC = () => {
  ...
  return (
    <div className="container py-8">
      {/* ✅ SEO Tags */}
      <Helmet>
        <title>Categories | VideoSoundEvent</title>
        <meta name="description" content="Browse and discover products organized by categories on VideoSoundEvent." />
        <link rel="canonical" href="https://videosoundevents.com/categories" />
        <meta property="og:title" content="Categories | VideoSoundEvent" />
        <meta property="og:description" content="Browse and discover products organized by categories on VideoSoundEvent." />
        <meta property="og:url" content="https://videosoundevents.com/categories" />
      </Helmet>
