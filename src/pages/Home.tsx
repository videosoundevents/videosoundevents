...
const Home: React.FC = () => {
  ...
  const seoContent = {
    ...
    en: {
      ...
      description:
        "Rent high-quality audio, video, lighting equipment, and special effects for any events — parties, concerts, festivals.",
      keywords:
          ...
          <div className="bg-black/70 py-24 px-4">
            <div className="container mx-auto text-center">
              ...
              <Button size="lg" asChild>
                <Link to="/categories">{t("view_catalog")}</Link>
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {topCategories.map((category) => {
              ...
              return (
                ...
                >
                  {IconComponent && (
                    <IconComponent size={48} className="mb-4 text-primary" />
                  )}
